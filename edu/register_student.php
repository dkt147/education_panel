        ...
        <section class="signup">
            ...
            <div class="container">
                <div class="signup-content">
                    <form method="POST" id="signup-form" class="signup-form" action="register_student.php" enctype="multipart/form-data">
                        <h2 class="form-title">Register Student's</h2>
                        <div class="form-group">
                            <input type="text" class="form-input" name="city" id="name" placeholder="City"/>
                        </div>
                        <div class="form-group">
                            <input type="number" class="form-input" name="num_stu" id="email" placeholder="No.Of Students"/>
                        </div>
                        <div class="form-group">
                            <input type="text" class="form-input" name="education" id="password" placeholder="Education"/>
                        </div>
                        <div class="form-group">
                            <input type="number" class="form-input" name="days" id="name" placeholder="Days"/>
                        </div>
                        <div class="form-group">
